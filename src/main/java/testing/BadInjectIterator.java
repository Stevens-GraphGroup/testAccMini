 ...
 */
public class BadInjectIterator extends BranchIterator implements OptionDescriber {
  private static final Logger log = LogManager.getLogger(BadInjectIterator.class);
